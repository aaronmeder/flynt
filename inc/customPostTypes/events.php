...
/**
 * This is an example file showcasing how you can add custom Events to your Flynt theme.
 *
...
add_action('init', function (): void {
    $labels = [
        'name'                  => _x('Events', 'Event General Name', 'flynt'),
        'singular_name'         => _x('Event', 'Event Singular Name', 'flynt'),
    ...
    register_post_type('aaronmeder_events', $args);
});
